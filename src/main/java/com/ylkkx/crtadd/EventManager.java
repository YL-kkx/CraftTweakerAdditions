...
public class EventManager {
    ...
    public static final EventList<MCClientChatReceivedEvent> MCClientChatReceivedEventList = new EventList<>();
    ...
    @ZenMethod
    public static IEventHandle onClientChatReceived(IEventManager manager, IEventHandler<MCClientChatReceivedEvent> event) {
        return MCClientChatReceivedEventList.add(event);
    }
